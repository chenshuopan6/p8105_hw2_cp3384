...
Totally 483 participants were recruited, of these 145 develop MCI.
...
dataset.** When reading the Amyloid data set, I skipped the first row in
the excel table and changed some unintelligible column names in the
table to reasonable column names to help us better merge the data sets.
This data set has a total of 487 rows and 6columns.key variables: id,
Baseline, After_two_year, After_four_year, After_six_year,
After_eight_year
...
After combination, there are totally 475 observations, 6columns .The Key
variables of this dataset are : id, current_age, sex, education, apoe4,
